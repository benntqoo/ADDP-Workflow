...
| 命令 | 功能 | 使用场景 |
|-----|------|---------|
| `/start` | 快速理解项目 | 首次接触项目时 |
| `/sync` | 恢复工作状态 | 新会话开始时 |
| `/context` | 同步上下文理解 | 确认理解一致性 |
| `/plan` | 任务规划设计 | 开始新功能前 |
| `/learn` | 记录决策知识 | 重要决定后 |
| `/meta` | 定制项目规范 | 新项目或重大调整 |
| `/doc` | 智能文档维护 | 更新项目文档 |
| `/update-spec` | 更新CLAUDE.md | 固化决策到规范 |

**SDK开发命令（5个）**

| 命令 | 功能 | 参数 |
|-----|------|------|
| `/sdk-design` | API设计助手 | [功能描述] |
| `/sdk-example` | 示例代码生成 | basic/advanced/all |
| `/sdk-test` | 测试套件生成 | unit/integration/all |
| `/sdk-doc` | 文档生成 | api/guide/migration/all |
| `/sdk-release` | 发布准备 | major/minor/patch/check |
...
| `sdk-design-expert` | SDK设计 | API设计、跨平台、开发者体验 |
